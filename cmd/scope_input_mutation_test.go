...
func cmdScopeInputMutationFixtureConfig() *config.Config {
...
func TestCommandRuntimeScopeInputMutationIsolation(t *testing.T) {
	input := newCommandRuntimeScopeInput(newScopeInputConfigOptions(snapshot.New(cmdScopeInputMutationFixtureConfig())), cliRuntimeOptions{})
