...
func TestReport_ReusesImportJSONShape(t *testing.T) {
	...
	const want = `{"profile":"record","policy":"","dry_run":false,"stats":{"total":100,"ok":97,"error":2,"skip":1},"messages":[{"type":"error","row":42,"field":"email","code":"constraint","text":"duplicate email"},{"type":"skip","row":7,"code":"empty_required","text":"name is required"}]}`
	if string(got) != want {
