...
type rawField struct {
	...
	// Its value is a pkgmeta.TermReference; renaming the property requires a separate migration.
	...
	// StringText stores the field title pkgmeta.TermReference as JSON when authored with reference `_t(...)`.
	...
	// HelpText stores the field help pkgmeta.TermReference as JSON when authored with reference `_t(...)`.
...
// Overridable for tests (json.Marshal/Unmarshal rarely fail on pkgmeta.FieldResolvedSpec).
var (
	rawFieldJSONMarshal   = json.Marshal
	rawFieldJSONUnmarshal = json.Unmarshal
)

func (field *rawField) SetResolvedSpec(spec *pkgmeta.FieldResolvedSpec) error {
	if field == nil {
		return nil
	}
	if spec == nil {
...
func (field *rawField) GetResolvedSpec() (*pkgmeta.FieldResolvedSpec, error) {
	if field == nil {
		return nil, nil
	}
	...
	var spec pkgmeta.FieldResolvedSpec
