...
func mergeSelectionByValue(base, addends []pkgmeta.FieldSelectionItem) []pkgmeta.FieldSelectionItem {
	byValue := make(map[string]pkgmeta.FieldSelectionItem)
	order := make([]string, 0, len(base))

	add := func(item pkgmeta.FieldSelectionItem) {
	...
	out := make([]pkgmeta.FieldSelectionItem, 0, len(order))
...
func selectionItemsFromField(field *pkgmeta.Field, spec *pkgmeta.FieldResolvedSpec) []pkgmeta.FieldSelectionItem {
	if spec != nil && len(spec.Structural.Selection) > 0 {
		return append([]pkgmeta.FieldSelectionItem(nil), spec.Structural.Selection...)
	}
	if field == nil {
		return nil
	}
	...
	var items []pkgmeta.FieldSelectionItem
...
func isDynamicSelectionField(field *pkgmeta.Field, spec *pkgmeta.FieldResolvedSpec) bool {
	if spec != nil {
...
func childDeclaresFullSelection(spec *pkgmeta.FieldResolvedSpec) bool {
	if spec == nil {
		return false
	}
...
func fieldHasSelectionAdd(field *pkgmeta.Field) bool {
	if field == nil {
		return false
	}
...
func resolveSelectionFieldConflict(base, child *pkgmeta.Field) (*pkgmeta.Field, error) {
	if child == nil {
		return base, nil
	}
	if base == nil {
	...
	out := *base
	out.BaseModel = pkgmeta.BaseModel{}
	...
	outSpec := &pkgmeta.FieldResolvedSpec{}
	if baseSpec != nil {
		*outSpec = *baseSpec
	} else {
...
func overlayStructuralSelectionAdd(dst, src *pkgmeta.FieldStructuralSpec) {
	if dst == nil || src == nil {
		return
	}
...
func mergeStorageHints(base, child *pkgmeta.FieldStructuralStorageHints) *pkgmeta.FieldStructuralStorageHints {
	if child == nil {
		return base
	}
	out := &pkgmeta.FieldStructuralStorageHints{}
	if base != nil {
		*out = *base
	}
...
func overlayBehaviorSelectionAdd(dst, src *pkgmeta.FieldBehaviorSpec) {
	if dst == nil || src == nil {
		return
	}
	if src.Compute != nil {
...
func applySelectionLegacyColumns(field *pkgmeta.Field, spec *pkgmeta.FieldResolvedSpec) {
