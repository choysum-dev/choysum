...
// Effective projection lives in pkgmeta.Model / meta_model (see MergeSameNameModelsByExtensionChain).
type rawModel struct {
	...
	Module     *pkgmeta.Module `gorm:"foreignKey:ModuleId" json:"module"`
}
