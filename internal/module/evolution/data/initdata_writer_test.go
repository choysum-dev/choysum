...
import (
	...
	initdatawriter "github.com/choysum-dev/choysum/internal/import/writer/initdata"
	dataloader "github.com/choysum-dev/choysum/internal/module/evolution/data"
	importpkg "github.com/choysum-dev/choysum/pkg/import"
)

func TestInitdataWriter_Write(t *testing.T) {
	runtimeScope := dataloader.NewDefaultLoaderScopeForTest(t)
	dir := t.TempDir()
...
func TestInitdataWriter_WriteUnexpectedUnitType(t *testing.T) {
	writer := initdatawriter.Writer{}
...
func TestInitdataWriter_WriteLoadErrorMapped(t *testing.T) {
	runtimeScope := dataloader.NewDefaultLoaderScopeForTest(t)
	dir := t.TempDir()
	dataloader.WriteDataFileForTest(t, dir, map[string]any{
		"records": []any{
...
func TestInitdataWriter_WritePlainError(t *testing.T) {
	runtimeScope := dataloader.NewDefaultLoaderScopeForTest(t)
	unit := initdataplan.Unit{
		ModuleName: "auth",
...
func TestInitdataWriter_WriteNilUnits(t *testing.T) {
	writer := initdatawriter.Writer{}
