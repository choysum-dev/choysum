...
func TestModuleUninstallerCleanModelsClearsMetaModelDataOnly(t *testing.T) {
	...
	demoMapping := &metadata.ModelData{
		Module: seed.module.Name, Name: "seed_row", Application: "demo", Model: "Thing", ResID: resID,
	}
	otherMapping := &metadata.ModelData{
		Module: otherModule.Name, Name: "other_row", Application: "other", Model: "Thing", ResID: otherResID,
	}
	...
	if err := db.Create(&metadata.ModelData{
		Module: seed.module.Name, Name: "seed_row", Application: "demo", Model: "Thing", ResID: xid.New().String(),
	}).Error; err != nil {
