...
type ModelData struct {
	...
	Application string `gorm:"type:varchar(255);not null;index:idx_model_data_application_model"`
	Model       string `gorm:"type:varchar(255);not null;index:idx_model_data_application_model"`
