...
func TestFeUnitPackageAndPathStubMatchers(t *testing.T) {
	...
	cases := []struct {
		...
		{"./storeScopeManager", "/x/storeScopeManager", "/other.ts", "", false},
		{"@/web/web/stores/registry", "/modules/web/web/stores/registry", "/modules/web/web/controllers/formController.ts", "", false},
