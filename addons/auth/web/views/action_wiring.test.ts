...
describe('auth view action wiring', () => {
  it('wires User list/form views to permission-aware action ids', () => {
    ...
    expect(list).toContain("entityTitle: 'User'");
    ...
    expect(form).toContain("entityTitle: 'User'");
  ...
  it('wires Role list/form views to permission-aware action ids', () => {
    ...
    expect(list).toContain("entityTitle: 'Role'");
    ...
    expect(form).toContain("entityTitle: 'Role'");
    ...
    expect(form).toContain('label="Advanced Mode"');
  ...
  it('wires Session list/form views to permission-aware action ids', () => {
    ...
    expect(list).toContain("entityTitle: 'Session'");
    ...
    expect(form).toContain("entityTitle: 'Session'");
  ...
  it('wires Token list/form views to permission-aware action ids', () => {
    ...
    expect(list).toContain("entityTitle: 'Token'");
    ...
    expect(form).toContain("entityTitle: 'Token'");
