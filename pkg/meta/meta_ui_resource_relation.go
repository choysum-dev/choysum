...
type UiResourceMenuRoute struct {
...
func (r *UiResourceMenuRoute) TableName() string {
	return "meta_ui_resource_menu_route"
}

type UiResourceRouteAction struct {
	BaseModel          `gorm:"embedded"`
...
func (r *UiResourceRouteAction) TableName() string {
	return "meta_ui_resource_route_action"
}
