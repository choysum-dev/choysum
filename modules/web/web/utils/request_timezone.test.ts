...
test('resolveRequestTimezone: prefers saved User.Timezone over browser', () => {
  expect(resolveRequestTimezone('America/New_York', 'Asia/Shanghai')).toBe('America/New_York');
});

test('resolveRequestTimezone: falls back to browser when User.Timezone empty', () => {
...
test('resolveRequestTimezone: falls back to browser when saved timezone is invalid', () => {
...
test('resolveRequestTimezone: returns empty when both missing or invalid', () => {
...
test('detectBrowserTimezone: returns a non-empty IANA-like string in jsdom', () => {
...
test('detectBrowserTimezone: returns empty string when Intl resolution throws', () => {
