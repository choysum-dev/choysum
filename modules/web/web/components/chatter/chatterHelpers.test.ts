...
test('formatFieldChangeSummary > uses the localized field fallback when the audit row has no field name', () => {
  expect(
    formatFieldChangeSummary(
...
test('formatFieldChangeSummary > normalizes empty values and bare action kinds', () => {
  expect(
    formatFieldChangeSummary(
