...
// OChatter needs useChatterTimeline, auth, and registry store mocks at setup;
// full mount needs store/composable stubs at setup; import smoke only for this knife.

test('OChatter smoke: default export is a named Vue component', async () => {
  const mod = await import('./OChatter.vue');
