...
test('OBinaryField/OImageField mapping contract > OBinaryField renders descriptor text from attachmentBindingId', () => {
...
test('OBinaryField/OImageField mapping contract > OBinaryField keeps upload envelope and remove protocol for binary attachments', () => {
  const s = source('OBinaryField.vue');
...
test('OBinaryField/OImageField mapping contract > OImageField supports descriptor previewUrl and fallback text', () => {
