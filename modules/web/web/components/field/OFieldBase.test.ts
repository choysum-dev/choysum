...
// OFieldBase needs useField bindings and dialog child wiring at setup;
// full mount needs store/composable stubs at setup; import smoke only for this knife.

test('OFieldBase smoke: default export is a named Vue component', async () => {
  const mod = await import('./OFieldBase.vue');
