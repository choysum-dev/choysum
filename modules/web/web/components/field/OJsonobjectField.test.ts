...
// OJsonobjectField needs vue-json-pretty and useField mocks at setup;
// full mount needs store/composable stubs at setup; import smoke only for this knife.

test('OJsonobjectField smoke: default export is a named Vue component', async () => {
  const mod = await import('./OJsonobjectField.vue');
