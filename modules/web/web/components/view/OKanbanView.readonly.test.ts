...
test('OKanbanView laneFieldReadonly (T5.4) > reads isReadonly from static fieldsMetadata only', () => {
...
test('OKanbanView laneFieldReadonly (T5.4) > waits for OSearchView first-frame query-update instead of mount apply', () => {
