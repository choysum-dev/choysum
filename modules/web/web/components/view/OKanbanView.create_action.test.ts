...
// Full suite needs kanbanController / create-route DI; mount needs heavy mocks.

test('OKanbanView create_action smoke: default export is a named Vue component', async () => {
