...
// Full suite needs listController / search first-frame DI; mount needs heavy mocks.

test('OListView firstframe smoke: default export is a named Vue component', async () => {
