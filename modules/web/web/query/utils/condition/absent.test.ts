...
test('asPresentCondition: returns undefined for nullish, empty array, and empty object', () => {
...
test('asPresentCondition: preserves non-empty values', () => {
...
test('combinePresentConditions: uses nullish checks so present 0/false are preserved', () => {
