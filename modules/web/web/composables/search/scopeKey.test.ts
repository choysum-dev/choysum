...
test('normalizeScopeKey: strips query and hash, collapses slashes, trims trailing slash', () => {
...
test('normalizeScopeKey: replaces numeric and opaque id segments with :id', () => {
