...
/**
 * Gallery-only barrel for L2 primitives (not exported from the public web entry).
 */
...
export { default as ComboboxAnchor } from './combobox/ComboboxAnchor.vue';
export { default as ComboboxContent } from './combobox/ComboboxContent.vue';
export { default as ComboboxInput } from './combobox/ComboboxInput.vue';
export { default as ComboboxItem } from './combobox/ComboboxItem.vue';
