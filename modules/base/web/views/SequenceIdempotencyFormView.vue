...
<template>
  ...
  >
    <el-card shadow="never" class="bfv-card">
      <template #header
        ><div class="bfv-card__header"><span>Sequence Idempotency Record</span></div></template
      >
      <el-row :gutter="12">
        <el-col :xs="24" :sm="12" :md="8"
          ><OManyToOneField :store="store" prop="SequenceId" label="Sequence" :search-view="SequenceListView" search-view-title="Select Sequence"
        /></el-col>
        <el-col :xs="24" :sm="12" :md="8"
          ><OManyToOneField :store="store" prop="CompanyId" label="Company" :search-view="CompanyListView" search-view-title="Select Company"
        /></el-col>
        <el-col :xs="24" :sm="12" :md="8"><OVarCharField :store="store" prop="IdempotencyKey" label="Idempotency Key" /></el-col>
      </el-row>
      <el-row :gutter="12">
        <el-col :xs="24" :sm="12" :md="6"><OIntField :store="store" prop="Count" label="Count" /></el-col>
        <el-col :xs="24" :sm="12" :md="6"><OBooleanField :store="store" prop="DryRun" label="Dry Run" /></el-col>
        <el-col :xs="24" :sm="12" :md="6"><OBigintField :store="store" prop="RangeStart" label="Start" /></el-col>
        <el-col :xs="24" :sm="12" :md="6"><OBigintField :store="store" prop="RangeEnd" label="End" /></el-col>
      </el-row>
      <el-row :gutter="12">
        <el-col :xs="24" :sm="12"><OVarCharField :store="store" prop="CodeSnapshot" label="Code Snapshot" /></el-col>
        <el-col :xs="24" :sm="12"><OVarCharField :store="store" prop="RequestHash" label="Request Hash" /></el-col>
      </el-row>
      <el-row :gutter="12">
        <el-col :xs="24"><OJsonobjectField :store="store" prop="FormatSnapshot" label="Format Snapshot" /></el-col>
      </el-row>
      <el-row :gutter="12">
        <el-col :xs="24" :sm="12" :md="8"><ODateTimeField :store="store" prop="ExpiresAt" label="Expires At" /></el-col>
      </el-row>
    </el-card>
  </OFormView>
</template>
