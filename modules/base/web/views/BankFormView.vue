...
<template>
  ...
  >
    <el-card shadow="never" class="bfv-card">
      <template #header
        ><div class="bfv-card__header"><span>Bank Information</span></div></template
      >
      <el-row :gutter="12">
        ...
        <el-col :xs="24" :sm="12" :md="8"><OVarCharField :store="store" prop="BIC" label="BIC" /></el-col>
      </el-row>
      <el-row :gutter="12">
        ...
        <el-col :xs="24" :sm="12" :md="8"
          ><OManyToOneField
            ...
            search-view-title="Select Address"
