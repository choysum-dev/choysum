...
import type { UntypedQueryCondition, QueryCondition } from '../types';
...
export function toRepoCondition<T>(condition: UntypedQueryCondition | [] | undefined): QueryCondition<T> | [] {
