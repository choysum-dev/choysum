...
/**
 * DefaultOperations resolves model field defaults, including dependency-aware function defaults.
 */
export class DefaultOperations {
  /**
   * Compute default field values:
   * - Support literal defaults (non-functions).
   * - Support function defaults that read existing or recursively generated dependencies through a Proxy.
   * - Detect circular dependencies and throw.
   * - Skip the field when a dependency is missing, matching the existing behavior.
   */
