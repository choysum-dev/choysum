...
function storeMeta(ctor: ModelStatic<TranslationTermBaseModel>) {
...
async function ensureTermUniqueIndex(ctor: ModelStatic<TranslationTermBaseModel>): Promise<void> {
...
export default class TranslationTermBaseModel extends BaseModel {
  ...
  static async GetTranslations(
    this: ModelStatic<TranslationTermBaseModel>,
...
function hostApplication(ctor: any): string {
  return String(storeMeta(ctor as ModelStatic<TranslationTermBaseModel>)?.application || '').trim();
}
