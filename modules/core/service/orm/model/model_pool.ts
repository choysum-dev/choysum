 ...
 */
export function pool<C extends ModelConstructor = never>(application: string, shortName: string): C {
 ...
 */
export function dial<C extends ModelConstructor = never>(fullModelName: string): ModelService<C> {
