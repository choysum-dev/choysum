...
<template>
  <OPage
    ...
    action-import
    action-export
    :action-import-upload-hint="_t('Upload a UTF-8 CSV with columns Mode.')"
  >
    <RoleUiResourceListView createAction="/auth/ui-resource-grants/new" selection-mode="multiple" />
  </OPage>
</template>
