...
test('normalizeUiResourceRequires: returns empty for nullish and blank strings', () => {
...
test('normalizeUiResourceRequires: throws for non-array values after string parsing', () => {
...
test('normalizeUiResourceRequires: parses arrays and JSON array strings; dedupes empties', () => {
...
test('selectInspectedUiResource: keeps objects and clears invalid rows', () => {
  const row = { Id: '1' };
