...
<template>
  ...
  >
    <el-card shadow="never" class="ufv-card">
      <template #header
        ><div class="ufv-card__header"><span>Account Information</span></div></template
      >
      <el-row :gutter="12">
        <el-col :xs="24" :sm="12" :md="8" :lg="6" :xl="6">
          <OImageField :store="store" prop="Avatar" label="Avatar" />
        </el-col>
        <el-col :xs="24" :sm="12" :md="8" :lg="6" :xl="6">
          <OVarCharField :store="store" prop="Username" label="Username" :rules="[{ required: true, message: 'Required' }]" />
        </el-col>
        <el-col :xs="24" :sm="12" :md="8" :lg="6" :xl="6">
          <OVarCharField :store="store" prop="Email" label="Email" />
        </el-col>
        <el-col :xs="24" :sm="12" :md="8" :lg="6" :xl="6">
          <OVarCharField :store="store" prop="Phone" label="Phone" />
        </el-col>
        <el-col :xs="24" :sm="12" :md="8" :lg="6" :xl="6">
          <OBooleanField :store="store" prop="IsActive" label="Active" widget="switch" />
        </el-col>
        <el-col :xs="24" :sm="12" :md="8" :lg="6" :xl="6">
          <OVarCharField :store="store" prop="FirstName" label="First Name" />
        </el-col>
        <el-col :xs="24" :sm="12" :md="8" :lg="6" :xl="6">
          <OVarCharField :store="store" prop="LastName" label="Last Name" />
        </el-col>
        <el-col :xs="24" :sm="12" :md="8" :lg="6" :xl="6">
          <OVarCharField :store="store" prop="FullName" label="Full Name" />
        </el-col>
        <el-col :xs="24" :sm="12" :md="8" :lg="6" :xl="6">
          <OVarCharField :store="store" prop="Language" label="Language" />
        </el-col>
        <el-col :xs="24" :sm="12" :md="8" :lg="6" :xl="6">
          <OVarCharField :store="store" prop="Timezone" label="Timezone" />
        </el-col>
        <el-col :xs="24" :sm="12" :md="8" :lg="6" :xl="6">
          <OManyToOneRefField :store="store" prop="CompanyId" label="Company" @value-click="onCompanyValueClick" />
        </el-col>
        <el-col :xs="24" :sm="12" :md="8" :lg="6" :xl="6">
          <OJsonobjectField :store="store" prop="Preferences" label="Preferences" :pretty="true" />
        </el-col>
      </el-row>

      <el-row :gutter="12">
        <el-col :xs="24" :sm="12" :md="8" :lg="6" :xl="6">
          <ODateTimeField :store="store" prop="LastLogin" label="Last Login" />
        </el-col>
        <el-col :xs="24" :sm="12" :md="8" :lg="6" :xl="6">
    ...
    <el-tabs model-value="roles" type="card" class="ufv-tabs">
      <el-tab-pane label="Roles" name="roles">
        <OManyToManyField :store="store" prop="Roles" label="" :search-list="RoleListView" search-view-title="Select Role">
          <OCharField :store="store" prop="Roles.Id" label="ID" />
          <OVarCharField :store="store" prop="Roles.Name" label="Name" />
          <ODateTimeField :store="store" prop="Roles.CreatedAt" label="Created At" />
        </OManyToManyField>
      </el-tab-pane>

      <el-tab-pane label="Sessions" name="sessions">
        <OOneToManyField :store="store" prop="Sessions" label="">
          <OCharField :store="store" prop="Sessions.Id" label="ID" />
          <OVarCharField :store="store" prop="Sessions.Status" label="Status" />
          <ODateTimeField :store="store" prop="Sessions.LastActivityAt" label="Last Activity" />
          <ODateTimeField :store="store" prop="Sessions.CreatedAt" label="Created At" />
        </OOneToManyField>
      </el-tab-pane>

      <el-tab-pane label="Tokens" name="tokens">
        <OOneToManyField :store="store" prop="Tokens" label="">
          <OCharField :store="store" prop="Tokens.Id" label="ID" />
          <OVarCharField :store="store" prop="Tokens.TokenType" label="Type" />
          <ODateTimeField :store="store" prop="Tokens.CreatedAt" label="Created At" />
        </OOneToManyField>
      </el-tab-pane>
    </el-tabs>
  </OFormView>
...
import type { TagClickPayload as RefTagClickPayload } from '@/web/web/components/field/OManyToManyRefTagsField.vue';
